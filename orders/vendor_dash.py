...
def adminPendingOrders(request):
    ...
    return render(request, 'ecom/pending-orders.html', context)
...
def adminConfirmedOrders(request):
    ...
    return render(request, 'ecom/confirmed-orders.html', context)
...
def adminCompletedOrders(request):
    ...
    return render(request, 'ecom/completed-orders.html', context)
...
def adminCanceledOrders(request):
    ...
    return render(request, 'ecom/canceled-orders.html', context)
